...
\begin{figure}[!h]
  \centerline{\xymatrix{
      \calC \ar[rr]^(0.25){F} & \ar@2{->}[d]^{\alpha} & \calD \ar[rr]^(0.25){G} & \ar@2{->}[d]^{\beta} & \calE \\
      \calC \ar[rr]^(0.25){F'} & \ar@2{->}[d]^{\alpha'} & \calD \ar[rr]^(0.25){G'} &  \ar@2{->}[d]^{\beta'} & \calE \\
      \calC \ar[rr]^(0.25){F''} & & \calD \ar[rr]^(0.25){G''} & & \calE \\
    }}
  \caption{Interchange Law}
\end{figure}
\vspace{9mm}

\begin{figure}[!h]
  \centerline{\xymatrix{
      & Fa \ar[r]^{G} \ar[d]^{\alpha_a} & G(Fa) \ar[r]^{\beta_{Fa}} \ar[d]^{G\alpha_a} \ar[rd]^{(\beta \circ \alpha)_a}& G'(Fa) \ar[d]^{G'\alpha_a} \ar[r]^{\beta'_{Fa}} & G''(Fa) \ar[d]^{G''\alpha_a} \\
      a \ar[ur]^{F} \ar[r]^{F'} \ar[dr]_{F''} & F'a \ar[r]^{G} \ar[d]^{\alpha'_a} & G(Fa') \ar[d]^{G\alpha'_a} \ar [r]^{\beta_{F'a}} & G'(F'a) \ar[r]^{\beta'_{F'a}} \ar[d]^{G'\alpha'_a} \ar[rd]^{(\beta' \circ \alpha')_a} & G''(F'a) \ar[d]^{G''\alpha'_a} \\
      & F''a \ar[r]^{G} & G(F''a) \ar[r]^{\beta_{F''a}} & G'(F''a) \ar[r]^{\beta'_{F''a}} & G''(F''a)
    }}
  \caption{Interchange Law Proof}
\end{figure}
\vspace{9mm}
